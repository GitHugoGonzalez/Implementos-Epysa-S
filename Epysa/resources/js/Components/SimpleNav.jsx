...
export default function SimpleNav() {
  ...
  // rol puede venir como string (legacy) o como objeto { nombre_rol }
  const roleName =
    (user?.rol?.nombre_rol ?? user?.rol ?? "")
      .toString()
      .trim()
      .toLowerCase();

  const isJefe = roleName === "jefe";
        ...
        <div className="flex h-20 items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="hidden items-center gap-2 sm:flex">
              ...
              {/* Ajusta rutas a las que realmente tienes */}
              <NavLink
                href="/insumos/index"
        ...
        {user && (
          <div className="border-t border-blue-200 bg-white pb-1 pt-4">
            ...
            <div className="mt-3 space-y-1">
              <ResponsiveNavLink href={route("profile.edit")} className="text-gray-800">
                Mi Perfil
              </ResponsiveNavLink>
              {isJefe && (
                <ResponsiveNavLink href="/admin/usuarios" className="text-gray-800">
                  Gestionar usuarios
                </ResponsiveNavLink>
              )}
              <ResponsiveNavLink method="post" href={route("logout")} as="button" className="text-gray-800">
                Cerrar Sesión
              </ResponsiveNavLink>
            </div>
          </div>

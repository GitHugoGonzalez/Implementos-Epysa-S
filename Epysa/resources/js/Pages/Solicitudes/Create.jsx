      ...
      <div className="max-w-2xl mx-auto bg-white shadow rounded-2xl p-6">
        ...
        <form onSubmit={submit} className="space-y-4">
          ...
          <div>
            ...
            {errors.id_insumo && <p className="text-red-600 text-sm mt-1">{errors.id_insumo}</p>}
          </div>
          ...
          <div>
            ...
            {errors.id_sucursal && <p className="text-red-600 text-sm mt-1">{errors.id_sucursal}</p>}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              />
              {errors.fecha_sol && <p className="text-red-600 text-sm mt-1">{errors.fecha_sol}</p>}
            </div>
          </div>
            ...
            >
              ...
              {estados.map((estado) => (
                <option
                  ...
                  disabled={estado.desc_estado === 'Urgente' && !canMarkUrgent}
                >
                  {estado.desc_estado}
                </option>
              ))}
            </select>
            {errors.id_estado && <p className="text-red-600 text-sm mt-1">{errors.id_estado}</p>}
            {!canMarkUrgent && (
              <p className="text-xs text-gray-500 mt-1">
                Solo administradores pueden seleccionar <b>Urgente</b>.
              </p>
            )}
          </div>

...
export default function Dashboard() {
  ...
  const goAprobaciones = (e) => {
    e.preventDefault();
    router.visit("/aprobaciones", { preserveScroll: true, preserveState: true });
  };

  const goHistorial = (e) => {
    e.preventDefault();
    router.visit(route("solicitudes.historial"), { preserveScroll: true, preserveState: true });
  };

  const goLogistica = (e) => {
    e.preventDefault();
    router.visit(route("logistica.index"), { preserveScroll: true, preserveState: true });
  };
